...
<?php if ($is_logged_in): ?>
    ...
    <?php else: ?>
        ...
        <header style="background-image: url('/../assets/img/test.png'); background-repeat: repeat; background-size: auto 100%; background-position: center; opacity: 0.85; height: 100px; border: 0.5px solid black;">
