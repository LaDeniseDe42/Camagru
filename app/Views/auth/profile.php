...
<div id="mdpModal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <form action="profile.php" method="post">
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token']) ?>">
            <input type="text" name="username" value="<?= htmlspecialchars($username) ?>" autocomplete="username" style="display:none;">
            <input type="password" name="password" id="modalMdp" placeholder="Nouveau mot de passe" autocomplete="new-password">
            <input type="password" name="confirm_password" id="modalInput" placeholder="Confirmer le mot de passe" autocomplete="new-password">
