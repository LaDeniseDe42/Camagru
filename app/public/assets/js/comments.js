...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".deleteComment").forEach(btn => attachDeleteListener(btn, filePath));
    document.querySelectorAll(".editComment").forEach(btn => attachEditListener(btn, filePath));
});
